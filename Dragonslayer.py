...
class Tile:
    ...
    def __init__(self, blocked, block_sight = None):
        ...
        #Default 'fog of war' effect
        if block_sight is None: block_sight = blocked
        self.block_sight = block_sight
 
class Rect:
    #a rectangle on the map. used to describe a room.
...
def place_objects(room):
    ...
    monster_chances['dragon'] = from_dungeon_level([[15, 3], [30, 5], [60, 7]])
    ...
    for i in range(num_monsters):
        ...
        if not is_blocked(x, y):
            ...
            if choice == 'orc':
                ...
                monster = Object(x, y, 'D', 'dragon', libtcod.darker_green,
                                 blocks=True, fighter=fighter_component, ai=ai_component)
...
def handle_keys():
    ...
    if game_state == 'playing':
        ...
        if key.vk == libtcod.KEY_UP or key.vk == libtcod.KEY_KP8:
            ...
            if key_char == 'i':
                #show the inventory; use a selected item
                chosen_item = inventory_menu('Press the key next to an item to use it, or any other to cancel.\n')
                if chosen_item is not None:
                    chosen_item.use()
 
            if key_char == 'd':
                #show the inventory; drop a selected item
...
def check_level_up():
    ...
    if player.fighter.xp >= level_up_xp:
        #level up and ask to raise some stats
        player.level += 1
        ...
        while choice == None:  #keep asking until a choice is made
            choice = menu('Level up! Choose a stat to raise:\n',
                          ['Fortitude (+20 HP, from ' + str(player.fighter.max_hp) + ')',
...
def new_game():
    ...
    message('Welcome stranger! Prepare to purge the cave of dragons!', libtcod.red)
...
def next_level():
    ...
    dungeon_level += 1
    message('Gathering your nerve, you descend the stairs...', libtcod.red)
...
def main_menu():
    ...
    while not libtcod.console_is_window_closed():
        ...
        libtcod.console_print_ex(0, SCREEN_WIDTH/2, SCREEN_HEIGHT/2-4, libtcod.BKGND_NONE, libtcod.CENTER,
                                 'DRAGONSLAYER')
        libtcod.console_print_ex(0, SCREEN_WIDTH/2, SCREEN_HEIGHT-2, libtcod.BKGND_NONE, libtcod.CENTER, 'A Dreaming Insomniac production')
...
libtcod.console_init_root(SCREEN_WIDTH, SCREEN_HEIGHT, 'Dragonslayer', False)
